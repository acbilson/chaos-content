...
4. Subconscious actions originate from our hearts, i.e. the core of who we are.
...
{{< diagram >}}
flowchart LR
	 Sunday[Sunday Gathering] --- SpecialInterest[Special Interest] & Discipleship --- Friendship
{{< /diagram >}}
...
"Seeker" refers to a person who is not yet committed to {{< strike >}}Sunday gatherings{{< /strike >}} Jesus but has courageously jumped the chasm between their environment and the Church enough to attend a Sunday gathering. It is a testament to the compelling power of Jesus' community that anyone makes it through the doors.
...
"Member" refers to an individual who has promised to pay regular {{< strike >}}dues{{< /strike >}} tithe, to attend more Sunday gatherings than they miss, and sometimes to volunteer.

A church with member registration is trying to weed out the "seekers" from the "finders" (made that last up). A member registry is useful for a number of reasons, such as to count the actual number of committed {{< strike >}}attendees {{< /strike >}} Christians to gauge the relative growth of church commitment over time.
